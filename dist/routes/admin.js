...
router.post("/restaurants/:res_id/add-restaurant-images", upload, admin_controller_1.default.RestaurantImage);
router.post("/dishes/:dish_id/add-dish-images", upload, admin_controller_1.default.DishImage);
